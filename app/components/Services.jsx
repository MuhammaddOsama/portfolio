    ...
    <section id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      <div className="text-center mb-12">
        ...
        <p className="max-w-2xl mx-auto mt-5 text-gray-400">
          I provide high quality developement and design solutions, ensuring
          seamless experience across web platform.
        </p>
      </div>
      <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6">
        {SERVICES_DATA.map(({ id, title, description, Icon }) => (
          <motion.div
            ...
            key={id}
            className="border border-gray-400 rounded-lg px-8 py-12 cursor-pointer hover:translate-y-3 transform duration-500 "
          >
