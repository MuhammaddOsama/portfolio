          ...
          <form className="flex flex-col space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 rounded-lg bg-[#1f1f1f] border border-[#33353f] h-32 resize-none text-white placeholder-[#9ca2a9] focus:ring-2 focus:ring-[#00adb5] focus:outline-none transition-all duration-300 "
              />
            </div>
